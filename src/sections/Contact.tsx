              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <a 
                      href="https://drive.google.com/file/d/1PVuLOcgYg8XRrVWvhFT7_iFIt41zOzLE/view?usp=drive_link"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-[#0056b3] text-white hover:bg-[#004494] px-5 py-2.5 rounded-full text-sm font-medium transition-colors"
                    >
                      Resume
                    </a>
                  </div>
